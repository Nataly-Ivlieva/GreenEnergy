...
🔧 System Components
1️⃣ Generator & Ingestion Service (Java, Spring Boot)
...
2️⃣ Backend Service (Java, Spring Boot)
...
3️⃣ Time-Series Storage (PostgreSQL)
...
4️⃣ Machine Learning Module (Python)
